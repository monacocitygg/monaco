...
Cfg.strings = {
    ...
    noAccessError = "[ERRO] CinematicCam: Pelo menos um dos seguintes valores deve ser verdadeiro! Cfg.useButton, Cfg.useCommand",
    wrongUIError = "[ERRO] CinematicCam: Especifique apenas UM UI no arquivo de configuração!",

    menuTitle       = "Câmera Cinemática",
    menuSubtitle    = "Controle a Câmera Cinemática",

    toggleCam       = "Câmera ativa",
    toggleCamDesc   = "Ativar/desativar câmera",

    precision       = "Precisão da câmera",
    precisionDesc   = "Alterar a precisão do movimento da câmera",

    filter          = "Filtro",
    filterDesc      = "Alterar o filtro da câmera",

    filterInten     = "Intensidade do filtro",
    filterIntenDesc = "Alterar a intensidade do filtro da câmera",

    delFilter       = "Redefinir filtro",
    delFilterDesc   = "Remover filtro e redefinir valores",

    showMap         = "Mostrar Minimapa",
    showMapDesc     = "Ativar/desativar minimapa",

    freeFly         = "Alternar para Modo de Voo Livre",
    freeFlyDesc     = "Alternar para Modo de Voo Livre ou voltar ao Modo de Drone",

    charControl     = "Alternar Controle de Personagem",
    charControlDesc = "Alternar para Controle de Personagem ou voltar ao Controle de Câmera",

    attachCam       = "Anexar câmera a: ",
    attachCamDesc   = "Anexar a câmera a uma entidade à sua frente",

    pointEntity     = "Apontar câmera para entidade",
    pointEntityDesc = "Alternar entre apontar para entidade selecionada",

    ctrlHelpRoll    = "Rolagem Esquerda/Direita",
    ctrlHelpMove    = "Movimento",
    ctrlHelpRotate  = "Rotação"
