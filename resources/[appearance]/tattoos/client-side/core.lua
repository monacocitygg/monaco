...
function openTattooShop()
	...
	SendNUIMessage({ openNui = true, shop = atualShop, tattoo = Tattoos, sexo = sexo })
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- ATUALIZARTATTOO
-----------------------------------------------------------------------------------------------------------------------------------------
...
CreateThread(function()
	...
	for _,v in pairs(Locations) do
		table.insert(Table,{ v[1],v[2],v[3],1.75,"E","Loja de Tatuagem","Pressione para abrir" })
	end
		...
		if LocalPlayer["state"]["Route"] < 900000 then
			...
			if not IsPedInAnyVehicle(Ped) then
				...
				for _,v in pairs(Locations) do
					...
					if Distance <= 2 then
						TimeDistance = 1
						-- exports["hoverfy"]:registerInteraction("Tattoos","E","Pressione para interagir","LOJA DE TATUAGEM",vec3(v[1],v[2],v[3]),2.0)
