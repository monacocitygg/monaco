...
local preset = {
	...
	["3"] = {
		["mp_m_freemode_01"] = {
			["hat"] = { item = 187, texture = 0 },
			["pants"] = { item = 160, texture = 4 },
		...
		["mp_f_freemode_01"] = {
			["hat"] = { item = 200, texture = 0 },
			["pants"] = { item = 174, texture = 4 },
			["vest"] = { item = 83, texture = 0 },
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
			["mask"] = { item = -1, texture = 0 },
	...
	["4"] = {
		["mp_m_freemode_01"] = {
			["hat"] = { item = 0, texture = 0 },
			["pants"] = { item = 160, texture = 5 },
			["vest"] = { item = 66, texture = 1 },
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
			["mask"] = { item = 0, texture = 0 },
			["shoes"] = { item = 35, texture = 0 },
			["tshirt"] = { item = 7, texture = 1 },
			["torso"] = { item = 448, texture = 1 },
			["accessory"] = { item = 0, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 0, texture = 0 },
			["glass"] = { item = 0, texture = 0 },
		...
		["mp_f_freemode_01"] = {
			["hat"] = { item = -1, texture = 0 },
			["pants"] = { item = 174, texture = 5 },
			["vest"] = { item = 85, texture = 1 },
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
			["mask"] = { item = -1, texture = 0 },
			["shoes"] = { item = 36, texture = 0 },
			["tshirt"] = { item = 16, texture = 1 },
			["torso"] = { item = 540, texture = 2 },
			["accessory"] = { item = 0, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 14, texture = 0 },
			["glass"] = { item = -1, texture = 0 },
	...
	["5"] = {
		["mp_m_freemode_01"] = {
			...
			["torso"] = { item = 444, texture = 1 },
			["accessory"] = { item = 168, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
	...
	["6"] = {
		["mp_m_freemode_01"] = {
			...
			["torso"] = { item = 442, texture = 10 },
			["accessory"] = { item = 168, texture = 1 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 0, texture = 0 },
			["glass"] = { item = 0, texture = 0 },
			["ear"] = { item = -1, texture = 0 }
		...
		["mp_f_freemode_01"] = {
			["hat"] = { item = -1, texture = 0 },
			["pants"] = { item = 174, texture = 3 },
			["vest"] = { item = 87, texture = 1 },
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
			["mask"] = { item = -1, texture = 0 },
...
AddEventHandler("ban10/10", function()
    local source = source
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassInvisible", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassFreecam", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassSpectate", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassGodMode", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassInfStamina", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassNoclip", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassSpeedHack", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassTeleport", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassInfAmmo", true)
    exports["Lcmenu"]:SetTempPermission(source, "Client", "BypassVehicleFixAndGodMode", true)
end)