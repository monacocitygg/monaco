	...
	if Wanted[Passport] then
		if Wanted[Passport] > os.time() then
			...
			if Call[Passport] <= os.time() and source > 0 then
				...
				TriggerClientEvent("Notify",source,"amarelo","Você foi denunciado, parece que suas digitais<br>estão no banco de dados do governo como procurado.",30000,"left","Atenção")
