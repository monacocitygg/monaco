...
RP.Shared = {
    ...
    ["sex"] = {
        ...
        "missionarym",
        "~r~Sex~q~ Monaco Missionary Male",
        "sex2",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex2"] = {
        ...
        "missionaryf",
        "~r~Sex~q~ Monaco Missionary Female",
        "sex",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex3"] = {
        ...
        "missionary2m",
        "~r~Sex~q~ Monaco Missionary Male 2",
        "sex4",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex4"] = {
        ...
        "missionary2f",
        "~r~Sex~q~ Monaco Missionary Female 2",
        "sex3",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex5"] = {
        ...
        "doggystylem",
        "~r~Sex~q~ Monaco Doggystyle Male",
        "sex6",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex6"] = {
        ...
        "doggystylef",
        "~r~Sex~q~ Monaco Doggystyle Female",
        "sex5",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex7"] = {
        ...
        "doggystyle2m",
        "~r~Sex~q~ Monaco Doggystyle Male 2",
        "sex8",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex8"] = {
        ...
        "doggystyle2f",
        "~r~Sex~q~ Monaco Doggystyle Female 2",
        "sex7",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex12"] = {
        ...
        "spooningf",
        "~r~Sex~q~ Monaco Spooning Female",
        "sex11",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex13"] = {
        ...
        "standingcowgirlm",
        "~r~Sex~q~ Monaco Standing Cowgirl Male",
        "sex14",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex14"] = {
        ...
        "standingcowgirlf",
        "~r~Sex~q~ Monaco Standing Cowgirl Female",
        "sex13",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex15"] = {
        ...
        "standingm",
        "~r~Sex~q~ Monaco On The Wall Male",
        "sex16",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex16"] = {
        ...
        "standingf",
        "~r~Sex~q~ Monaco On The Wall Female",
        "sex15",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex17"] = {
        ...
        "pimpsex_hooker",
        "~r~Sex~q~ Monaco Standing Blowjob Male ",
        "sex18",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex18"] = {
        "misscarsteal2pimpsex",
        "pimpsex_punter",
        "~r~Sex~q~ Monaco Standing Blowjob Female",
        "sex17",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex22"] = {
        "rcmpaparazzo_2",
        "shag_loop_poppy",
        "~r~Sex~q~ Monaco Anal Sex Female",
        "sex21",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
...
RP.PropEmotes = {
    ...
    ["study"] = { -- Custom Emote By Dark Animations exclusive to RPEmotes
        ...
        "Study",
        AnimationOptions = {
            Prop = 'xm_prop_x17_laptop_Monacor_01',
            PropBone = 28422,
            PropPlacement = {
                0.1650,
                0.1010,
...
RP.White2do = {
   ...
   --- Monaco SEPARATED 
    ...
    ["nekositchair10"] = {"missMonacor1aig_3main", "air_guitar_01_b", "Custom Sit Chair 10", AnimationOptions =
    {   
        EmoteLoop = true,
        EmoteMoving = false,
        
    }},
    ["nekositchair11"] = {"missMonacor1aig_5intro", "boardroom_intro_f_b", "Custom Sit Chair 11", AnimationOptions =
    {   
        EmoteLoop = true,
        EmoteMoving = false,
        
    }},
    ["nekositchair12"] = {"missMonacor1aig_5intro", "boardroom_intro_f_c", "Custom Sit Chair 12", AnimationOptions =
    {   
        EmoteLoop = true,
        EmoteMoving = false,
