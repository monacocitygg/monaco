Locales['no'] = {
 -- Norwegian 🇳🇴
        ...
        ['whitecustom'] = '~p~Monaco Emotes 3.0~w~',
        ['whitecustom2do'] = '~p~Monaco Emotes 4.0~w~',
        ['whitecustom5to'] = '~p~Monaco Emotes 5.0~w~',
        ['whitecustom6to'] = '~p~Monaco Emotes 6.0~w~',
        ['whitecustom7mo'] = '~p~Monaco Emotes 7.0~w~',
