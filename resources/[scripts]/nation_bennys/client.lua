...
RegisterNetEvent('actionmenu')
AddEventHandler('actionmenu',function()
...
AddEventHandler("nation:applymods", function(veh,vname, plate)
	if veh then
		local vehplate = GetVehicleNumberPlateText(veh)
		if plate then
			vehplate = plate
		end
		local custom = func.getSavedMods(vname,vehplate)
		if custom then
