...
RegisterNUICallback("requestChest",function(Data,Callback)
	local myInventory,myChest,invPeso,invMaxpeso,chestPeso,chestMaxpeso,myHasBolso,myHasVip,tHasBolso,tHasVip,myHasSerendibite,myHasPainite,tHasSerendibite,tHasPainite = vSERVER.openChest()
	...
	if myInventory then
		Callback({
			...
			myHasBolso = myHasBolso,
			myHasVip = myHasVip,
			tHasBolso = tHasBolso,
			tHasVip = tHasVip,
			myHasSerendibite = myHasSerendibite,
			myHasPainite = myHasPainite,
			tHasSerendibite = tHasSerendibite,
			tHasPainite = tHasPainite
		})
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
