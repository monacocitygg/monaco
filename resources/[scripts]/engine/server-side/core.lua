...
-----------------------------------------------------------------------------------------------------------------------------------------
Street = {}
Tunnel.bindInterface("engine",Street)
-----------------------------------------------------------------------------------------------------------------------------------------
-- GETNITROFUEL (reads from hud export)
-----------------------------------------------------------------------------------------------------------------------------------------
function Street.GetNitroFuel(Plate)
	return exports["hud"]:GetNitro(Plate)
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- PAYMENTFUEL
-----------------------------------------------------------------------------------------------------------------------------------------
function Street.paymentFuel(Price,Plate,vehFuel,LastFuel,Network)
	local source = source
...
-- VEHICLEFUEL
-----------------------------------------------------------------------------------------------------------------------------------------
function Street.vehicleFuel(Plate)
