...
function ClassWork(Work)
	...
	elseif Work == "Fruitman" then
		Result = "Agricultor"
	elseif Work == "Dismantle" then
		Result = "Desmanchador"
	elseif Work == "Tows" then
		Result = "Rebocador"
	elseif Work == "Diver" then
		Result = "Mergulhador"
	elseif Work == "Fisherman" then
		Result = "Pescador"
	elseif Work == "Runner" then
		Result = "Corredor"
	...
	elseif Work == "Cleaner" then
		Result = "Jardineiro"
	elseif Work == "Faxineiro" then
		Result = "Faxineiro"
	elseif Work == "PostOp" then
		Result = "Carteiro"
	elseif Work == "Milkman" then
		Result = "Milkman"
	elseif Work == "Tractor" then
		Result = "Tratorista"
	end
